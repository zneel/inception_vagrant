...
```
If you have been working from 42 computer, change the default machine folder by selecting Preferences from the File menu in the VM VirtualBox main window. Then, in the displayed window, click on the General tab. Change the Default Machine folder on your sgoinfre. 
